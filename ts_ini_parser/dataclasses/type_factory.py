...
_RULE_TYPEMAP = {
        ...
        'kvp_page_scalar_line': lambda children: generic_factory(ts_ini_file.ScalarVariable, children),
        'kvp_array_line': kvp_array_line_factory,
        'kvp_page_array_line': kvp_array_line_factory,        
        ...
        'outputchannels_section': lambda children: generic_factory(ts_ini_file.OutputChannelsSection, children),
